    ...
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-0.5">
          <h1 className="text-2xl font-bold tracking-tight">Safelink Decoder</h1>
          <p className="text-sm text-muted-foreground">
            Decode Microsoft Outlook / Office 365 Safelinks to reveal the original destination URL.
          </p>
        </div>
      </div>
