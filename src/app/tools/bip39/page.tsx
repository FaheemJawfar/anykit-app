    ...
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-0.5">
          <h1 className="text-2xl font-bold tracking-tight">BIP39 Mnemonic Generator</h1>
          <p className="text-sm text-muted-foreground">
            Generate secure seed phrases for cryptocurrency wallets like Bitcoin and Ethereum.
          </p>
        </div>
      </div>
