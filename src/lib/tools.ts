...
export const tools: Tool[] = [
  ...
  },
  {
    id: 'json-sql-schema',
    name: 'JSON to SQL Schema',
    description: 'Generate SQL CREATE statements from JSON',
    category: 'developer',
    icon: 'Database',
    path: '/tools/json-sql-schema',
    tags: ['json', 'sql', 'schema', 'generate'],
    isNew: true,
  },
  {
    id: 'datetime-hub',
    name: 'Advanced DateTime Hub',
    description: 'Timezone converter and date arithmetic',
    category: 'math',
    icon: 'Clock',
    path: '/tools/datetime-hub',
    tags: ['date', 'time', 'timezone', 'calc'],
    isNew: true,
  },
  {
    id: 'js-logger',
    name: 'JS Console Prettifier',
    description: 'Visual debugger for complex objects',
    category: 'developer',
    icon: 'Bug',
    path: '/tools/js-logger',
    tags: ['js', 'console', 'debug', 'pretty'],
    isNew: true,
  },
  {
    id: 'gql-json',
